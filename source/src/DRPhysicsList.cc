...
G4_DECLARE_PHYSCONSTR_FACTORY(DRPhysicsList);

using namespace CLHEP;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

DRPhysicsList::DRPhysicsList() 
...
void DRPhysicsList::SetRunParameters(RunParameters params)
{
	_params = params;
}
...
void DRPhysicsList::ConstructParticle()
{
...
void DRPhysicsList::ConstructProcess()
{
//  AddTransportation();
//  ConstructDecay();
//  ConstructEM();
...
void DRPhysicsList::ConstructOp()
{
	fCerenkovProcess           = new G4Cerenkov("Cerenkov");

//	if (_params.useParametrization==0)
//	{
...
void DRPhysicsList::SetVerbose(G4int verbose)
{
